...
"tomelab": {
  ...
  /* ---------------------------------------------------------------
     Template — duplicate this block for the next Moonshot Lab
     project. Everything here is a placeholder.
  --------------------------------------------------------------- */
  "kimi": {
  id: "kimi",
  name: "Kimi",
  ...
  description: "Kimi is my vision of what artificial intelligence should become — a lovable desktop companion that lives on your screen instead of inside a chat window. It combines advanced AI with personality, humor, animations, and contextual awareness to create an assistant that feels genuinely alive. Rather than being another productivity tool, Kimi is designed to become a trusted companion that helps, reacts, learns, and grows alongside its user.",

  heroCtas: {
    primaryLabel: "Explore Features",
    primaryHref: "#features",
    secondaryLabel: "Back to Portfolio",
    secondaryHref: "index.html#kimi",
  },
  ...
  overviewCards: [
    ...
    },
    {
      icon: "&#129504;",
      title: "Features",
      desc: "Explore Kimi's intelligent, interactive, and animated capabilities.",
      href: "#features"
    },
    {
      icon: "&#10022;",
      title: "Personality",
      desc: "Discover how Kimi feels alive through emotions and behaviors.",
      href: "#features"
    },
    {
      icon: "&#128737;",
    ...
    },
    {
      icon: "&#128640;",
      title: "Future Vision",
      desc: "See how Kimi will continue evolving over time.",
      href: "#cta"
    },
  ],

  whatIs: {
    eyebrow: "WHAT IS KIMI?",
    headingLines: [
      "More than an AI.",
      "More than software."
    ],
    headingHighlight: "Kimi is a companion.",
    description: "Kimi is designed to live directly on your desktop as an intelligent animated companion. Instead of switching tabs to interact with AI, users simply talk to Kimi naturally while working, creating, studying, or gaming. It combines advanced intelligence, expressive animations, contextual awareness, and personality to make AI feel like a genuine digital partner.",
    checklist: [
  ...
  features: [
    ...
    },
    {
      ...
      desc: "With permission, Kimi understands your screen, explains code, identifies problems, and provides contextual help."
    },
    {
      icon: "&#127918;",
      title: "Dynamic Personality",
      desc: "Sleeps, plays games, reacts unpredictably to your work and gameplay, and performs thousands of unique animations inspired by Diana from Pragmata, making Kimi feel truly alive."
    },
  ],
},
